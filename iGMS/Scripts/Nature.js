...
function Nature(pagenum, page, seach) {
    $.ajax({
        url: '/Nature/List',
        type: 'get',
        ...
        success: function (data) {
            ...
            if (data.code == 200) {
                $.each(data.c, function (k, v) {
                    ...
                    table += '<a class="nav-link" href="/Nature/Edits/' + v.id + '">';
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.code == 200) {
                ...
                window.location.href = "/Nature/Index";
    ...
    var id = $(this).closest('tr').attr('id');
        if (confirm("Xóa " + id + " Sẽ Xóa Hết Những Dữ Liệu Liên Quan Đến " + id + " Này")) {
            $.ajax({
                ...
                success: function (data) {
                    if (data.code == 200) {
                        successSwal(data.msg); Nature(pagenum, page, seach);
                    } else { alert(data.msg) }
                }
            })
        }
