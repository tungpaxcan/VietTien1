...
function CateGoods(pagenum, page, seach) {
    $.ajax({
        url: '/categoods/List',
        type: 'get',
        ...
        success: function (data) {
            ...
            if (data.code == 200) {
                $.each(data.c, function (k, v) {
                    ...
                    table += '<a class="nav-link" href="/CateGoods/Edits/' + v.id + '">';
...
function Add() {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.code == 200) {
                Swal.fire({
                    title: "Tạo Loại Hàng Thành Công",
                    icon: "success",
                ...
                window.location.href = "/CateGoods/Index";
            } else if (data.code == 300) {
                alert(data.msg)
            }
            else {
                alert("Tạo Loại Hàng Thất Bại")
            }
        },
        complete: function () {
...
function Edit() {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.code == 200) {
                Swal.fire({
                    title: "Sửa Loại Hàng Thành Công",
                    icon: "success",
                    buttonsStyling: false,
                    confirmButtonText: "Confirm me!",
                    customClass: {
    ...
    if (confirm("Bạn Muốn Xóa Dữ Liệu Này ???")) {
        $.ajax({
            ...
            success: function (data) {
                if (data.code == 200) {
                    Swal.fire({
                        title: "Xóa Loại Hàng Thành Công",
                        icon: "success",
                        buttonsStyling: false,
                        confirmButtonText: "Confirm me!",
                        customClass: {
